...
import { Box, Divider, Flex, HStack, Input, InputGroup, InputRightElement, Stack, Text } from "@chakra-ui/react";
        ...
        >
            ...
            <Box height={mobileScreen ? "50vh" : "60vh"} overflowY="auto" mx={2}>
                <Stack mt={5} gap={mobileScreen ? 4 : 10} mx={2}>
                    {DummyChat.toReversed().map((item, idx) => (
                        <>
                            <Flex direction="row" justifyContent="space-between" alignItems="center" key={idx}>
                                    ...
                                    <Box pos="relative" ml={2} mb={mobileScreen ? 8 : 9}>
                                        ...
                                        <>
                                            <Box
                                                ...
                                                zIndex={0}
                                            >
                                                <UserIcon width={mobileScreen ? "24" : "30"} height={mobileScreen ? "24" : "30"} color="gray" />
                                            </Box>
                                            <Box
                                                borderRadius="50%"
                                                width={mobileScreen ? "28px" : "34px"}
                                                ...
                                                zIndex={1}
                                            >
                                                    <UserIcon width={mobileScreen ? "24" : "30"} height={mobileScreen ? "24" : "30"} color="white" />
                                                </Box>
                                        </>
                                        )}
                                    </Box>
                                    <Box>
                                        <HStack alignItems="center">
                                            ...
                                            <Text fontSize={mobileScreen ? "xs" : "sm"} color="black">
                                                {item.date.toLocaleString('en-US', { timeZone: 'Asia/Jakarta' })}
                                            </Text>
                                        </HStack>
                                        <Text fontSize={mobileScreen ? "sm" : "md"} fontWeight="bold" color="black">
                                            {item.sender}
                                        </Text>
                                        <Text fontSize={mobileScreen ? "xs" : "sm"} color="black">
                                            {item.message}
