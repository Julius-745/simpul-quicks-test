...
import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Box, Button, Checkbox, Divider, HStack, Menu, MenuButton, MenuItem, MenuList, Select, Text } from "@chakra-ui/react";
                    ...
                    <AccordionItem key={idx}>
                            ...
                            <AccordionButton>
                                ...
                                >
                                    ...
                                    <HStack spacing={mobileScreen ? 2 : 4}>
                                        ...
                                        <Text>
                                            {item.date.toLocaleString('en-US', { timeZone: 'Asia/Jakarta' }).split(',')[0]}
                                        </Text>
                                        <AccordionIcon />
                                        <Menu>
                        ...
                        <AccordionPanel pb={4} ml={mobileScreen ? 2 : 8}>
                            <HStack borderColor="black">
                                <TimeIcon width={mobileScreen ? "16" : "20"} height={mobileScreen ? "16" : "20"} color="#2F80ED" />
                                <SingleDatepicker
                                    triggerVariant="input"
                                    triggerIcon={
                                        <DateIcon width={mobileScreen ? "12" : "15"} height={mobileScreen ? "12" : "15"} color="black" />
                                    }
                                    propsConfigs={{
                                        inputProps: {
                                            borderColor: "black"
                            ...
                            <HStack gap={5} mt={mobileScreen ? 2 : 4}>
                                <EditIcon width={mobileScreen ? "32" : "40"} height={mobileScreen ? "32" : "40"} color="#2F80ED" />
                                <Text>
                                    {item.description}
                                </Text>
                            </HStack>
